 ...
 */
//使用PatchesInfoFactory.createPatchesInfo构造PatchesInfoImpl类
public class PatchesInfoFactory {
    ...
    /*
     public class PatchesInfoImpl implements PatchesInfo {
            ...
            patchedClassesInfos.add(new PatchedClassInfo("com.meituan.sample.robusttest.l", "com.meituan.robust.patch.SampleClassPatchControl"));
            patchedClassesInfos.add(new PatchedClassInfo("com.meituan.sample.robusttest.p", "com.meituan.robust.patch.SuperPatchControl"));
            patchedClassesInfos.add(new PatchedClassInfo("com.meituan.sample.SecondActivity", "com.meituan.robust.patch.SecondActivityPatchControl"));
