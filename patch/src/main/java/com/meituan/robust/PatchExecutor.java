...
public class PatchExecutor extends Thread {
    ...
    //在 Thread 中的 run方法中 执行 patch()方法
    protected boolean patch(Context context, Patch patch) {
        ...
        try {
            ...
            //getPatchesInfoImplClassFullName 就是 PatchesInfoImpl 用于记录修改的类，及其对应的 ChangeQuickRedirect 接口的实现
        ...
        for (PatchedClassInfo patchedClassInfo : patchedClasses) {
            //原先包含 ChangeQuickRedirect 字段 的 类
            String patchedClassName = patchedClassInfo.patchedClassName;
            //ChangeQuickRedirect 接口的实现类
            ...
            try {
                ...
                for (Field field : fields) {
                    //找到原先old class 中的 插入的 ChangeQuickRedirect 类型 字段
                ...
                try {
                    ...
                    //set(Object obj, Object value) ： 向obj对象的这个Field设置新值value,因为changeQuickRedirectField 为static 所以obj 为 null
